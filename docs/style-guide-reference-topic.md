...
## Using media and images

Images and visual elements help parents and caregivers understand information more quickly. Use images only when they support the content and provide additional value to the reader.
...
- Demonstrating navigation steps.
- Showing screen layouts.
- Providing visual examples of app content.
- Supporting user instructions.

Avoid images when:

- Text alone provides sufficient explanation.
- The image does not contribute meaningful information.
- The image quality is poor or outdated.
- The image duplicates information already presented in the text.
...
- Consistent with the Bebbo interface.
...
- Stretched images.
- Pixelated graphics.
- Images with unnecessary annotations.

### Applying image dimensions

Use the standard image size below for all screenshots, illustrations, and interface references unless a specific document requires a different size.
...
Maintain a consistent image size throughout the document to improve readability and visual consistency.
